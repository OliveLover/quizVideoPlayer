...
var chance = 1;
var voice;
var quizSize = Object.keys(quizInfo_ox_1).length;
...
function createQuiz(questionNumber) {
  ...
  quiz_txt += "<h2>" + quizInfo_ox_1[questionNumber][0].question + "</h2>";
  quiz_txt += "</div>";
  quiz_txt += '</div>';
  ...
  quiz_txt +=
    '<p class="look1" onclick="selectAnswer(1)" style="font-size:150px; margin-left:20px">' +
    quizInfo_ox_1[questionNumber][1].select +
    "</p>";
  quiz_txt += "</div>";
  ...
  quiz_txt +=
    '<p class="look2" onclick="selectAnswer(2)" style="font-size:150px; margin-left:20px">' +
    quizInfo_ox_1[questionNumber][2].select +
    "</p>";
  quiz_txt += "</div>";
  quiz_txt += "</div>";
...
function checkAnswer(userAnswer) {
  ...
  var answer = quizInfo_ox_1[questionNumber][0].correct;
  if (Number(quizInfo_ox_1[questionNumber][0].correct) === Number(userAnswer)) {
...
function solutionQUiz() {
  var solution_txt = "";
  solution_txt += "<div>" + "<span style='color:red; font-weight:bold;'>해설 <br></span>" + quizInfo_ox_1[questionNumber][0].explain + "</div>";
