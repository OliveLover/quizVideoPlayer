...
function createScreenView() {
  ...
  screen_txt += "<div class='screenQuizGuide'>이번 시간에 학습한 내용을 퀴즈를 통해 확인해보겠습니다.<br>총 <span style='color:red;font-weight:bold;'>세 개</span>의 문제가 주어지며 기회는 <span style='color:red;font-weight:bold;'>두 번</span>입니다.<br>신중하게 참여해주세요</div > ";
  screen_txt += "</div>";
  screen_txt += "</div >";
